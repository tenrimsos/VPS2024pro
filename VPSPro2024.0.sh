...
preConfig() {
   ...
   echo "Agregando usuario ssh"; tput sgr0 ; tput setaf 4
   useradd user
   passwd user
   echo "Preconfiguracion correcta!"; tput sgr0 ; tput setaf 2
   configVPS
}
...
v2rayInstall() {
   ...
   echo "v2ray configurado correctamente"; tput sgr0 ; tput setaf 2
}
...
hysteria2Install() {
   ...
   bash hysteria2.sh
   echo "hysteria2 configurado correctamente"; tput sgr0 ; tput setaf 2
}
...
stunnelInstall() {
   ...
   echo "stunnel configurado correctamente"; tput sgr0 ; tput setaf 2
}
...
dropbearInstall() {
   ...
   echo "dropbear configurado correctamente"; tput sgr0 ; tput setaf 2
}
...
badVPNInstall() {
   ...
   echo "BadVPN configurado correctamente"; tput sgr0 ; tput setaf 2
}
...
squidInstall() {
   ...
   echo "squid configurado correctamente"; tput sgr0 ; tput setaf 2
}
...
shadowsocksInstall() {
   ...
   echo "shadowsocks configurado correctamente"; tput sgr0 ; tput setaf 2
}
...
openVPNInstall() {
   ...
   echo "OpenVPN configurado correctamente"; tput sgr0 ; tput setaf 2
}
...
strongswamInstall() {
   ...
   echo "Ejecutando servidor web para descargar configuracion del cliente..."; tput sgr0 ; tput setaf 4
   cd /root && python3 -m http.server
   echo "StrongSwam IKEv2 configurado correctamente"; tput sgr0 ; tput setaf 2
}
...
wireguardInstall() {
   ...
   echo "Wireguard configurado correctamente"; tput sgr0 ; tput setaf 2
}
