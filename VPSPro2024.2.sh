...
showHelp() {
   ...
   echo ""; tput sgr0 ; tput setaf 4
   echo "Ayuda"; tput sgr0 ; tput setaf 7
   echo ""
   echo "-v2ray"; tput sgr0 ; tput setaf 4 "instala el servidor v2ray"; tput sgr0 ; tput setaf 7
   
   
   echo "$(tput setaf 4)-v2ray    $(tput setaf 7) instala el servidor $(tput setaf 4)v2ray$(tput sgr 0)"
   echo "$(tput setaf 4)-hysteria $(tput setaf 7) instala el servidor $(tput setaf 4)hysteria2$(tput sgr 0)"
   echo "$(tput setaf 4)-squid    $(tput setaf 7) instala el servidor $(tput setaf 4)squid$(tput sgr 0)"
}
