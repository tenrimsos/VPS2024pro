...
showHelp() {
   ...
   echo "-hysteria"; tput sgr0 ; tput setaf 4 "instala el servidor hysteria2"; tput sgr0 ; tput setaf 7
   echo "-stunnel"; tput sgr0 ; tput setaf 4 "instala el servidor stunnel"; tput sgr0 ; tput setaf 7
   echo "-dropbear"; tput sgr0 ; tput setaf 4 "instala el servidor dropbear"; tput sgr0 ; tput setaf 7
}
