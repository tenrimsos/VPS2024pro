...
preConfig() {
   ...
   if grep -q "conf" user; then
      tput setaf 4; echo "Ya fue preconfigurado, posiblemente solo debas usar el comando 'apt update'."
   else
      echo ""; tput sgr0
      sudo apt update -y
...
stunnelInstall() {
   ...
   wget -O /etc/stunnel/stunnel.conf "https://raw.githubusercontent.com/tenrimsos/VPS2024pro/main/stunnel.conf"
...
shadowsocksInstall() {
   ...
   until [[ -z "$ssResponse" || "$ssResponse" =~ ^[1-12]$ ]]; do
      tput setaf 7; echo "$ssResponse: seleccion invalida."; tput sgr0
   ...
   if [[ "$ssResponse" = '1' ]]; then
      ...
      tput setaf 7; echo "Escribe la IP para el servicio shadowsocks"; tput sgr0
   ...
   # Abriendo puertos
   echo ""; tput sgr0
   tput setaf 4; echo "Abriendo puerto 8388 tcp y udp"; tput sgr0
   sudo iptables -I INPUT -p tcp --dport 8388 -j ACCEPT
   sudo iptables -I INPUT -p udp --dport 8388 -j ACCEPT
   echo ""; tput sgr0 ; tput setaf 2
   if [[ "$ssResponse" = '1' ]]; then
      tput setaf 2; echo "shadowsocks configurado correctamente"; tput sgr0
   else
      tput setaf 2; echo "shadowsocks+obfs configurado correctamente"; tput sgr0
   fi
}
...
installAllVPS() {
   tput setaf 4; echo "Se va configurar el VPS al completo"; tput sgr0
   configBANNER
   configMOTD
   
   tput setaf 4; echo "Instalando v2ray..."; tput sgr0
	 # Comandos para instalar v2ray
	 v2rayInstall
   
   tput setaf 4; echo "Instalando hysteria2..."; tput sgr0
   # Comandos para instalar hysteria2
	 hysteria2Install

   tput setaf 4; echo "Instalando stunnel..."; tput sgr0
   # Comandos para instalar stunnel
   stunnelInstall
		
		tput setaf 4; echo "Instalando dropbear..."; tput sgr0
		# Comandos para instalar dropbear
		dropbearInstall
		
   tput setaf 4; echo "Instalando squid..."; tput sgr0
   # Comandos para instalar squid
   squidInstall

   tput setaf 4; echo "Instalando BadVPN..."; tput sgr0
   # Comandos para instalar BadVPN
   badVPNInstall

   tput setaf 4; echo "Instalando shadowsocks+obfs..."; tput sgr0
   # Comandos para instalar shadowsocks+obfs
   shadowsocksInstall

   tput setaf 4; echo "Instalando OpenVPN..."; tput sgr0
   # Comandos para instalar OpenVPN
   openVPNInstall

   tput setaf 4; echo "Instalando IKEv2..."; tput sgr0
   # Comandos para instalar IKEv2
   strongswamInstall

   tput setaf 4; echo "Instalando Wireguard..."; tput sgr0
...
choiceExtraInstallation() {
   ...
   e_opciones=("Instalar obfs" "Instalar Certbot" "Instalar certificado Stunnel" "Configurar Puertos" "Configurar Banner" "Configurar MOTD" "Agregar usuario OpenVPN" "Agregar usuario Wireguard" "Menu Principal")
   e_seleccionadas=()
...
main() {
   ...
   #Configuracion de puertos con firewalld
      ...
      tput setaf 1, echo "Saliendo del script"
      sleep 3
      exit
   fi
}
