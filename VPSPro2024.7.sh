...
choiceExtraInstallation() {
   ...
   opciones=("Instalar obfs" "Instalar Certbot" "Instalar certificado Stunnel" "Configurar Puertos" "Configurar Banner" "Configurar MOTD" "Agregar usuario OpenVPN" "Agregar usuario Wireguard" "Finalizar y Salir")
   seleccionadas=()
